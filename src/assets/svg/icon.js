...
export const Poof2Svg = () => (
  ...
  >
    ...
    <rect
      ...
      height="40"
      rx="5"
      transform="rotate(-90 0 55.7407)"
      fill="white"
    />
  </svg>
);
export const BookedSvg = () => (
  <svg
    width="30"
    height="30"
    viewBox="0 0 44 44"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g filter="url(#filter0_f_135_27)">
      <circle cx="22" cy="22" r="20" fill="#33FD00" />
    </g>
    <defs>
      <filter
        id="filter0_f_135_27"
      ...
      >
        ...
        <feGaussianBlur
          stdDeviation="1"
          result="effect1_foregroundBlur_135_27"
        />
      </filter>
    </defs>
  </svg>
);
export const Wall2Svg = () => (
  <svg
    width="50"
    height="80"
    viewBox="0 0 9 172"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <rect width="9" height="172" rx="1" fill="white" />
  </svg>
);
export const Wall1Svg = () => (
  <svg
    width="80"
    height="50"
    viewBox="0 0 172 9"
...
export const Poof1Svg = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <rect width="55.7407" height="40" rx="5" fill="white" />
    <rect x="58.1296" width="55.7407" height="40" rx="5" fill="white" />
    <rect x="116.259" width="55.7407" height="40" rx="5" fill="white" />
  </svg>
);
export const Table3Svg = () => (
  <svg
    width="80"
    height="70"
    viewBox="0 0 172 82"
  ...
  >
    <rect
      ...
      height="40"
      rx="5"
      transform="rotate(90 40.0005 21.2695)"
      fill="white"
    />
    <rect
      x="171.999"
      ...
      height="40"
      rx="5"
      transform="rotate(90 171.999 20.7307)"
      fill="white"
    />
    <rect
      x="119"
      ...
      height="66"
      rx="5"
      transform="rotate(90 119 0)"
      fill="white"
    />
  </svg>
);
export const Table2Svg = () => (
  <svg
    width="50"
    height="70"
    viewBox="0 0 82 172"
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <rect x="21" y="132" width="40" height="40" rx="5" fill="white" />
    <rect x="21" width="40" height="40" rx="5" fill="white" />
    <rect y="53" width="82" height="66" rx="5" fill="white" />
  </svg>
);

export const Table1Svg = () => (
  <svg
    width="50"
    height="70"
    viewBox="0 0 157 176"
  ...
  >
    ...
    <rect
      ...
      height="40"
      rx="5"
      transform="rotate(-45 99 28.2842)"
      fill="white"
    />
    <rect
      y="147.284"
    ...
    <rect
      ...
      height="40"
      rx="5"
      transform="rotate(-45 100 147.284)"
      fill="white"
    />
    <circle cx="77.5" cy="89.5" r="49.5" fill="white" />
  </svg>
);
